...
class FMResourceBundle implements Installation, OrderedMigrationInterface
{
    ...
    protected function createFmResourceTable(Schema $schema)
    {
        ...
        $table->addColumn('link', 'string', ['length' => 1024, 'default' => '']);
        $table->addColumn('link_hash', 'string', ['length' => 32, 'default' => '']);
        $table->addColumn('is_person', 'boolean', ['default' => true]);
        $table->addColumn('score', 'decimal', ['scale' => 2, 'default' => 0]);
        $table->addColumn('quote_direct', 'decimal', ['scale' => 2, 'default' => 0]);
        $table->addColumn('quote_repost', 'decimal', ['scale' => 2, 'default' => 0]);
        $table->addColumn('cost_direct', 'decimal', ['scale' => 2, 'default' => 0]);
        $table->addColumn('cost_repost', 'decimal', ['scale' => 2, 'default' => 0]);
